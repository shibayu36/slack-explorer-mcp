...
- File Search (`search_files`)
  ...
  - Parameters
    - `query`: Basic search query. Use dedicated fields for inclusion modifiers (bare modifiers in this field are rejected). Exclusion modifiers prefixed with `-` (e.g., `-type:pdf`) ARE allowed here
